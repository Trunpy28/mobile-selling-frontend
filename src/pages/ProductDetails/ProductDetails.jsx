                        ...
                        <div>
                            ...
                            <div className="max-w-lg mx-auto py-7 rounded-lg ">
                                ...
                                <div className="bg-gray-900 p-4">
                                    <button className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-3 rounded-md transition-colors">
                                        MUA NGAY GIÁ {formatCurrency(product.price)}<sup>₫</sup>
                                    </button>
                                </div>
                            </div>
                        </div>
